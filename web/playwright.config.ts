...
export default defineConfig({
  ...
  webServer: { command: `${python} -m uvicorn workspace_app.api:app --host 127.0.0.1 --port 8876`, cwd: resolve('..'), env: { CAREER_OPS_ROOT: root }, url: 'http://127.0.0.1:8876/api/health', reuseExistingServer: false },
});
