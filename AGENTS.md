...
8. Run `python3 automation/analyze_application_keywords.py application-packages/<Company>/<Role>` and use the exact-term report to identify missing truthful keyword opportunities and unsupported keywords that should stay omitted.
