...
- `validate_resume_pdf.py`: checks a standalone one-page resume PDF, including the master resume, for page count, file size, extractable text markers, and bottom-page utilization using the same strict visual-fill threshold expected of application resumes.
