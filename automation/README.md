...
- `analyze_application_keywords.py`: reports exact job-description term coverage in the selected resume artifact. Use it during the alignment pass as deterministic support, not as an employer ATS score or a complete keyword universe. Supplement it with role-specific `--term` values for important JD terms the dictionary may not know.
