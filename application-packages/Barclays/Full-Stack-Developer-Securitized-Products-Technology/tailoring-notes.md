...
Default exact-term analyzer result: 19/19 found in the final resume after replacing the summarized posting with the full saved job description. Found terms: `authorization`, `AWS`, `based micro service`, `cloud`, `cloud based`, `cloud based micro`, `code reviews`, `debugging`, `Git`, `Java`, `Jenkins`, `micro service`, `micro service apis.`, `monitoring`, `object-oriented programming`, `requirements`, `service apis.`, `testing`, and `unit testing`.

Expanded Barclays-specific keyword pass: 32/45 found. Found terms: `Angular`, `authorization`, `AWS`, `based micro service`, `business requirement`, `cloud`, `cloud based`, `cloud based micro`, `code reviews`, `controls`, `debugging`, `Git`, `Issue resolution`, `Java`, `Jenkins`, `Logging`, `maintainable`, `Maven`, `messaging`, `micro service`, `micro service apis.`, `monitoring`, `object-oriented programming`, `Open Shift`, `Product Owner`, `ReactJS`, `requirements`, `scalable`, `service apis.`, `Spring Boot`, `testing`, and `unit testing`. Missing exact terms: `failover`, `front-end web application`, `governance`, `high-volume`, `Jenkins pipeline`, `OpenShift`, `optimized for performance`, `performance tuning`, `release engineering`, `risk`, `secure coding`, `Springboot`, and `stakeholders`. Several missing terms are variants or role-level governance terms already represented by adjacent evidence; unsupported or risky terms remain intentionally omitted unless Aryan can add confirmed source material.
