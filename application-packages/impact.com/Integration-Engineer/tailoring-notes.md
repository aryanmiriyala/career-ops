# impact.com - Integration Engineer Tailoring Notes

Primary role lane: technical integration / customer-facing SaaS implementation
Secondary angle: applied AI infrastructure, full-stack software, data/workflow systems, and support-adjacent troubleshooting

## Resume Direction

- Target Professional Title Clause: `Integration Engineer` appears once in the visible header/contact block.
- Professional Summary decision: omitted. The title line, current AI Gateway/customer-portal bullets, integration-heavy experience bullets, and technical skills section make the role fit clear without adding a summary.
- Resume angle: SaaS/client technical integration across REST APIs, JavaScript/TypeScript, HTML, SQL, documentation, troubleshooting, customer/admin workflows, onboarding-adjacent workflows, AI implementation, and data migration.
- Strongest evidence emphasized: Actual Reality AI Gateway and customer portal, SmartSolve AI integration roadmap and onboarding tracker, AAIS insurance data migration/billing/SQL automation, APKD healthcare workflow reliability, Career Ops ATS API integrations, and FalconGraph document ingestion/RAG.
- Cover-letter angle: impact.com needs an Integration Engineer who can understand client workflows, propose technical implementation paths, document integrations, troubleshoot onboarding issues, and apply AI practically. The letter connects that to customer portal/API integration, AI Gateway design, enterprise data workflows, and healthcare platform reliability.

## F-1 Work Authorization Gate

Status: Proceed - posting silent/ambiguous.

The posting does not explicitly state no sponsorship, independent permanent work authorization, U.S. citizen/permanent-resident-only eligibility, or clearance requirements. Proceeding while keeping sponsorship, E-Verify, and future work-authorization follow-up internal. No F-1, OPT, STEM OPT, E-Verify, visa, sponsorship, or Form I-983 language was added to the submitted resume or cover letter.
...
- Connection path: Search impact.com employees in Columbus, Customer Experience, Technical Services, Onboarding, Client Success, integrations, and BGSU alumni.
- Outreach status: Not started.
- Next follow-up: Identify one impact.com Columbus employee or recruiter before or immediately after submission.

## Job Keyword Map

- Exact posted title: Integration Engineer.
- Required technologies: HTML, JavaScript, SQL, REST APIs, web technologies, SaaS platforms.
- Required/priority responsibilities: technical solutions, design and integration, technical discovery, solution discussions, client requirements, client objectives, integration documentation, Onboarding team partnership, client onboarding, troubleshooting, technical issues, implementation, go live.
- AI requirement: hands-on application of AI to real-world challenges, sophisticated understanding of core AI principles.
- Customer-facing language: clients, business and technology stakeholders, customer-centric communication, patience, empathy, professionalism, client challenges, fast-paced customer issues.
- Domain language: commerce partnership marketing, affiliate marketing, digital marketing, partnerships, performance-based growth, SaaS platform.
- Low-value / boilerplate terms tracked but not forced: benefits, compensation, equal-opportunity language, RSU/bonus details, company slogans.
- Unsupported or risky terms to avoid: direct affiliate marketing industry employment, direct impact.com platform implementation, formal Sales Engineering title, direct external client ownership if not supported, and unrestricted work-authorization claims.
- Internal/private terms translated for recruiter readability: Plane became project-management API integration; private customer portal work became customer/admin workflow and implementation handoff language; AI Gateway internals were described as OpenAI-compatible model-call routing, policy, cost/rate controls, fallback behavior, observability, and decision records.

## Gap Recovery Gate

Gap recovery status: Pass - targeted source searches completed before omitting unsupported terms.
...
- Direct affiliate marketing industry experience is not claimed.
- Direct impact.com implementation experience is not claimed.
- Formal Sales Engineering or Integration Support title is not claimed.
- Direct ownership of external client discovery calls is not claimed; adjacent customer portal, documentation, support, teaching, and requirements-translation evidence is used instead.
- Direct enterprise SaaS onboarding ownership is adjacent through onboarding tracker/customer portal work, not overstated.

Recommended improvements:

- If Aryan has actually led external customer calls, onboarding workshops, integration discovery sessions, or client-facing implementation support, add that to `profile/experience-master.md` before future Integration Engineer or Sales Engineering applications.
- If Aryan has used affiliate tracking, adtech/martech tools, UTM/pixel tracking, partner APIs, Shopify integrations, or marketing analytics, document it before applying to impact.com or similar partnership-marketing platforms.
- Add any public-safe AI Gateway implementation details once code, tests, or design reviews are available, especially examples of rule definitions, model registry schema, cost accounting, request/response handling, and observability outputs.
